...
public class AgenteManager {
    ...
    public void registrarAgente() {
        ...
        String asignarEquipo = ConsoleUtils.leerTexto("Ingrese el arma que desea que tenga su agente: ");//NEW

        Agente nuevoAgente = new Agente(id, nombre, habilidad, asignarEquipo);
